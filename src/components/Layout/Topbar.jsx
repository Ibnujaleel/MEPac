                    ...
                    {activePanel === 'profile' && (
                        <div 
                            ...
                            <div style={{ padding: '8px' }}>
                                <button className="btn text-btn" style={{ width: '100%', textAlign: 'left', padding: '8px 12px', justifyContent: 'flex-start', alignItems: 'center', display: 'flex' }} onClick={() => togglePanel('profile', null)}>
                                    <User size={16} style={{ marginRight: '8px' }} /> View Profile
                                </button>
                                <button className="btn text-btn" style={{ width: '100%', textAlign: 'left', padding: '8px 12px', justifyContent: 'flex-start', alignItems: 'center', display: 'flex' }} onClick={() => togglePanel('profile', null)}>
                            ...
                            <div style={{ padding: '8px', borderTop: '1px solid var(--border-subtle)' }}>
                                <button className="btn text-btn" style={{ width: '100%', textAlign: 'left', padding: '8px 12px', color: 'var(--accent-red)', justifyContent: 'flex-start', alignItems: 'center', display: 'flex' }} onClick={() => {
